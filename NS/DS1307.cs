...
namespace Lib_DS1307
{
    public class DS1307
    {
        private const ushort Address = 0xA0; // DS1307 0x68 ' 104, PCF8583 0xA2 ' 162
        private const byte ReadAddress = 0xA3;
        private const byte WriteAddress = 0xA2;
        private const int ClockRate = 100;
        private const int Timeout = 1000;

        private const byte SecondsAddr = 0x02;
        private const byte MinutesAddr = 0x03;
        private const byte HoursAddr = 0x04;
        private const byte DayAddr = 0x05;
        private const byte DateAddr = 0x06;
        private const byte MonthAddr = 0x07;
        private const byte YearAddr = 0x08;
        private const byte ControlAddr = 0x00;
        private const byte RamAddr = 0x11;
        ...
        public readonly I2CDevice device;
        ...
        {
            byte[] buffer = ReadRam(ReadAddress, 7);
        ...
        private byte[] ReadRam(byte address, int expectedBytes)
        {
            ...
            int actual = device.Execute(transactions, Timeout);
